...
export default function TabLayout() {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <InvertedBorder color="#f2f2f2" style={{ zIndex: 1002, position: 'absolute', bottom: Platform.OS === 'android' ? 70 + tabBarBottom : 70, left: 0, height: 28, width: 28 }} />
      <InvertedBorder color="#f2f2f2" style={{ zIndex: 1002, position: 'absolute', bottom: Platform.OS === 'android' ? 70 + tabBarBottom : 70, right: 0, height: 28, width: 28, transform: [{ scaleX: -1 }] }} />
      <Tabs
          screenOptions={{
